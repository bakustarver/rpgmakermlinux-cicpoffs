...
The bash wrapper uses [native Linux libraries](DEPENDENCIES.md) to run Windows games ans can be considered as an alternative to WINE. It creates a local port of the Linux version from the Windows port and then executes it.
